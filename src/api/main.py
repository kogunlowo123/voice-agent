...
app = FastAPI(
    title="Voice Agent",
    description="Conversational voice AI agent that handles inbound and outbound calls, performs speech-to-text and text-to-speech, manages IVR flows, detects customer sentiment in real-time, and provides agent assist during live calls.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
