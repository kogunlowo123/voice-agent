"""Voice Agent - Main Agent Implementation."""
...
class VoiceAgentAgent:
    ...
    def __init__(self):
        ...
        self.ivr_management_enabled = True
        self.sentiment_detection_enabled = True
        self.agent_assist_enabled = True
        self._tool_dispatch = {
            "transcribe_call": self.tools.transcribe_call,
            "synthesize_speech": self.tools.synthesize_speech,
            "detect_intent": self.tools.detect_intent,
            "analyze_sentiment": self.tools.analyze_sentiment,
            "suggest_response": self.tools.suggest_response,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['speech_recognition', 'voice_synthesis', 'ivr_management', 'sentiment_detection', 'agent_assist'],
        )
    ...
    async def process_message(self, request: ChatRequest, user_id: str) -> ChatResponse:
        ...
        rag_results = await self.rag_pipeline.retrieve(
            ...
            top_k=5,
            filters={"user_id": user_id, "domain": "customer_service"},
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "suggest_response": ['suggest', 'response'],
        }
